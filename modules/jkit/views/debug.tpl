...
table.template_vars th, 
table.template_vars td {
...
{if $assigned_vars['xhprofid']}
<div>
    <a target="_blank" href="/xhprof_html/index.php?run={$assigned_vars['xhprofid']}&source=xhprof">xhprof</a>
</div>
{/if}
